...
const FacebookIcon = ({ fill, className }: SvgIconProps) => {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d="M16.6711 15.4688L17.2031 12H13.875V9.75C13.875 8.8008 14.339 7.875 15.8297 7.875H17.3437V4.92188C17.3437 4.92188 15.9703 4.6875 14.6578 4.6875C11.9156 4.6875 10.125 6.3492 10.125 9.35625V12H7.07806V15.4688H10.125V23.8547C10.7367 23.9508 11.3625 24 12 24C12.6375 24 13.2633 23.9508 13.875 23.8547V15.4688H16.6711Z"
        fill={fill || "white"}
      />
    </svg>
  );
